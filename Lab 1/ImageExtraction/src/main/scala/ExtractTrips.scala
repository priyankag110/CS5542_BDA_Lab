...
object ExtractTrips {
  ...
  def main(args: Array[String]) {
    ...
    val questionFile = "data/cocoqa/train/questions.txt"
    val answerFile = "data/cocoqa/train/answers.txt"
    val imgIDFile = "data/cocoqa/train/img_ids.txt"
    ...
    for(i <- 0 to keywords.length-1){
      ...
      var t = currentKeywordMatches.map(a => {
        ...
        var src = new File("C:\\Users\\Shawn\\Downloads\\train2017\\train2017"+a._5)
