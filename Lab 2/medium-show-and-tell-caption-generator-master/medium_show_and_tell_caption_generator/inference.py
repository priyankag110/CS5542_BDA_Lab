...
list_of_images = os.listdir("C:\\fence")
img_files_paths = r""
for image in list_of_images:
    img_files_paths += "C:\\fence\\"+image+","
...
tf.flags.DEFINE_string("model_path", r"C:\Big Data Analytics and Applications\medium-show-and-tell-caption-generator-master\model\show-and-tell.pb", "Model graph def path")
...
tf.flags.DEFINE_string("vocab_file", r"C:\Big Data Analytics and Applications\medium-show-and-tell-caption-generator-master\etc\word_counts.txt", "Text file containing the vocabulary.")
